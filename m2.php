  ...
  <div> <a href="shop.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/3 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="calpol.png" style="height:400px; width:610px;">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font  tracking-widest">Garrison Pharmacy</h2>
          <h1 class=" text-3xl title-font font-medium mb-1">Calpol Tablets</h1>
          <div class="flex mb-4">
           
          </div>
          <p class="leading-relaxed">Calpol 500 MG Tablet is the most widely used over-the-counter (OTC) medication. It is used for the treatment of fever. It also provides relief from headache, toothache, backache, nerve pain, musculoskeletal pain, etc. associated with/without fever. Calpol 500 MG Tablet works by decreasing the intensity of pain signals to the brain. It also prevents the release of prostaglandins, the chemical that causes pain and an increase in body temperature. 
<br></p>
    ...
    ?>
                ...
                <p class="title-font font-medium text-3xl ">Rs25.00</p><br><br>
