...
<body class="url" style="background-color:#070217;  ">
      ...
      <section style="margin-left: 10px;" >
          ...
          <div> <a href="index1.php"><button id="btn3"    class="flex  text-white  border-0 py-1 px-5 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
  ...
  <div style="margin-right:60px;"  class="form-row">
      ...
      <input  style="margin-top:47px;"  type="text" class="form-control" name="username"  placeholder="Enter you Email">
...
<br>
      ...
      <input style="margin-top:60px;" type="password" class="form-control" name ="confirm_password" placeholder="Confirm Password">
...
<br>
      ...
      <input style="margin-top:60px;" type="text" class="form-control" id="inputCity" placeholder="Enter Your Phone">
      <label style="margin-left:60px;" for="inputCity">City/State</label>
      <input style="margin-top:60px;" type="text" class="form-control" id="inputCity" placeholder="Enter Your City">
