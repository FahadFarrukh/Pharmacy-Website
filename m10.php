  ...
  <div> <a href="shop.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/3 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="pcam.png" style="height:400px; width:600px;">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 ml-5">
          ...
          <h1 class=" text-3xl title-font font-medium mb-1">Pcam Gel</h1>
          <div class="flex mb-4">
           
          </div>
          <p class="leading-relaxed">Pcam gel is used to provide relief from joint and bone pains and inflammation. Most of the time patients with osteoarthritis and rheumatoid arthritis suffer from a lot of bones and joint pain. Pcam gel is the best solution to control suffering.<br></p>
