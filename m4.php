  ...
  <div> <a href="shop.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/3 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded mt-20" src="surbexz.png" style="height:400px; width:600px;">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font  tracking-widest">Garrison Pharmacy</h2>
          <h1 class=" text-3xl title-font font-medium mb-1">Surbex-Z Tablets</h1>
          <div class="flex mb-4">
           
          </div>
          <p class="leading-relaxed">SURBEX-Z is a long strength vitamin tablet which is utilized for the rectification of Vitamin B Complex, Vitamin C, and zinc deficiency or lackness. It is good for the growth of hair, but it will not treat other causes of hair misfortune. Consult your doctor for further assessment.

SURBEX Z pills could be a combination of B vitamins utilized to treat or avoid vitamins lacking due to destitute count calories or, certain sicknesses, also liquor addiction, or pregnancy.<br></p>
    ...
    ?>
                ...
                <p class="title-font font-medium text-3xl ">Rs200.00</p><br><br>
