  ...
  <div> <a href="shop.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/3 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded mt-10" src="flagyl.png" style="height:350px; width:450px;">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 ml-40">
          ...
          <h1 class=" text-3xl title-font font-medium mb-1 mt-1">Flagyl</h1>
          <div class="flex mb-4">
           
          </div>
          <p class="leading-relaxed">Flagyl is an antibiotic that is used to treat bacterial infections of the vagina, stomach, liver, skin, joints, brain and spinal cord, lungs, heart, or bloodstream.

Flagyl is also used to treat trichomoniasis, a sexually transmitted disease caused by a parasite. Usually both sexual partners are treated at the same time, even if one has no symptoms.<br></p>
    ...
    ?>
                ...
                <p class="title-font font-medium text-3xl ">Rs70.00</p><br><br>
