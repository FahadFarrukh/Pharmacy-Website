...
?>
      ...
      <div> <a href="contact.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
        <div class="flex flex-col text-center w-full">
            ...
            <h1 id="contact" class="  font-medium title-font ">Your response has been submitted, our team will contact you soon.</h1>
</div>
