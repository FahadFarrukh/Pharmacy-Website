  ...
  <div> <a href="shop.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/3 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded ml-10 mt-10" src="calamox1.png" style="height:400px; width:410px;">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 ml-40">
          <h2 class="text-sm title-font  tracking-widest">Garrison Pharmacy</h2>
          <h1 class=" text-3xl title-font font-medium mb-1">Calamox</h1>
          <div class="flex mb-4">
           
          </div>
          <p class="leading-relaxed">Calamox is a 375 mg tablet consisting of pharmaceutical components, including amoxicillin-clavulanic acid. Calamox tablet has a generic name called calamine and is most commonly known in the market by its generic name.

Calamox tablet is primarily used for the treatment and prevention of bacterial infections most commonly found in people due to bacterial attacks.<br></p>
    ...
    ?>
                ...
                <p class="title-font font-medium text-3xl ">Rs155.00</p><br><br>
