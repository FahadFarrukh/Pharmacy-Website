...
?>
      ...
      <div> <a href="index1.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
        <div class="flex flex-col text-center w-full">
            <div><img id="response" src="https://cdn4.iconfinder.com/data/icons/toolbar-soft/512/alarm_alert_attention_beware_caution_danger_error-512.png"><div>
            <h1 id="contact" class="  font-medium title-font ">Sorry, there was an error, purchase again from our shop.</h1>
</div>
