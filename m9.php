  ...
  <div> <a href="shop.php"><button id="btn3"    class="flex  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">← Go Back</button></a></div>
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/3 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded ml-10 mt-10" src="extor.png" style="height:300px; width:500px;">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 ml-20">
          <h2 class="text-sm title-font  tracking-widest">Garrison Pharmacy</h2>
          <h1 class=" text-3xl title-font font-medium mb-1">Extor</h1>
          <div class="flex mb-4">
           
          </div>
          <p class="leading-relaxed">Extor is used to treat high blood pressure and heart failure. It is also used to improve the chance of living longer after a heart attack. In people with heart failure, it may also lower the chance of having to go to the hospital for heart failure. Extor belongs to a class of drugs called angiotensin receptor blockers (ARBs).<br></p>
    ...
    ?>
                ...
                <p class="title-font font-medium text-3xl ">Rs650.00</p><br><br>
